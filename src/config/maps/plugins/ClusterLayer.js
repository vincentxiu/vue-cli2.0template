define([
    ...
    return declare([GraphicsLayer], {
        constructor: function (options) {
            ...
            this._singleSym = options.singleSymbol || new SMS("circle", 10, null, new Color(options.singleColor));
        ...
        _clusterTest: function (p, cluster) {
            var distance = (
                Math.sqrt(
                    Math.pow((cluster.x - p[this._xField]), 2) + Math.pow((cluster.y - p[this._yField]), 2)
        ...
        _clusterCreate: function (p) {
            ...
            var cluster = {
                ...
                "attributes": {
                    "clusterCount": 1,
                    "clusterId": clusterId,
                    "extent": [p[this._xField], p[this._yField], p[this._xField], p[this._yField]]
                }
            };
        ...
        _addSingles: function (singles) {
            ...
            arrayUtils.forEach(singles, function (p) {
                var symbol = null;
                if ($.isFunction(this._renderSingleCallback)) {
                ...
                var g = new Graphic(
                    new Point(p[this._xField], p[this._yField], this._sr),
                    symbol,
                    p,
